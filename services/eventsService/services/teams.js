var parkingRepo = require('../data/teams');
...
exports.getVendorParkingIdByLatLng = function (req, res) {
    ...
    try {
        ...
        parkingRepo.getVendorParkingIdByLatLng(req, function (err, result) {            
            if(err) {
                console.log("Error: 500, returned " + err);
                return res.status(500).end();                
            }
...
exports.getAvailabilityParkingByLatLng = function (req, res) {
    ...
    try {
        ...
        parkingRepo.getAvailabilityParkingByLatLng(req, function (err, result) {            
            if(err) {
                console.log("Error: 500, returned " + err);
                return res.status(500).end();                
            }
